...
<template>
  ...
  >
    <div class="nui-tab-slider-inner" :class="props.classes?.inner">
      <div class="nui-tab-slider-track rounded-md" :class="props.classes?.track">
        <button
          ...
          :class="[
            modelValue === tab.value && 'shadow-sm transition-shadow duration-[1500ms] nui-active rounded-md',
            props.classes?.item,
          ]"
        ...
        <div v-show="modelValue" class="nui-tab-slider-naver text-slate-900"></div>
      </div>
    </div>
