<template>
  <div>
    ...
    <div class="mt-3 flex items-center justify-end gap-x-8">
      <div class="mb-[2px]">
        <BaseSelect v-model="perPage" rounded="md" size="md" label="" :classes="{
          wrapper: 'w-full w-40',
        }">
          <option :value="10">
            10 per page
      ...
      <CustomBasePagination :total-items="data?.total ?? 0" :item-per-page="perPage" :current-page="page" rounded="md" />
    </div>
