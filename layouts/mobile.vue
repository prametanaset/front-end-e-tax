    ...
    <div
      ...
      <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
        ...
        <NuxtLink to="/"
          ...
          <Icon v-if="route.name =='index'" name="mdi:home" class="size-7 text-black dark:text-gray-400 " />
          <Icon v-else name="mdi:home-outline" class="size-7 text-black dark:text-gray-400 " />


          <span class="text-[11px] text-slate-800 dark:text-gray-400">หน้าแรก</span>
        </NuxtLink>

        <!-- Wallet -->
        <NuxtLink to="/invoice/create/invoice"
          class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
          <Icon v-if="route.name =='invoice-mode-id'" name="mdi:invoice-text-plus" class="size-7 text-slate-600 dark:text-gray-400" />
          <Icon v-else name="mdi:invoice-text-plus-outline" class="size-7 text-slate-600 dark:text-gray-400" />

          <span class="text-[11px] text-slate-800 dark:text-gray-400">สร้าง</span>
        </NuxtLink>
        ...
        <NuxtLink to="/category"
          ...
          <Icon v-if="route.name =='category'" name="mdi:inbox" class="size-7 text-slate-600 dark:text-gray-400" />
          <Icon v-else name="mdi:inbox-outline" class="size-7 text-slate-600 dark:text-gray-400" />

          <span class="text-[11px] text-slate-800 dark:text-gray-400">คลัง</span>
        </NuxtLink>
