<template>
  <div>
    ...
    <div
      ...
      :class="isOpen ? '' : '-translate-x-full rtl:translate-x-full'"
    >
      <div class="py-4 px-6">
      ...
      <div class="flex flex-col h-16 w-full items-start justify-between">
        ...
        <div>
          ...
          <div
            class="group flex items-center px-6 py-1 transition cursor-pointer"
          >
            <NuxtLink to="/" class="flex flex-row items-center">
              <Icon
                name="material-symbols:aod-tablet-outline"
          ...
          <div
            class="group flex items-center px-6 py-1 transition cursor-pointer"
          >
            <NuxtLink to="/category" class="flex flex-row items-center">
              <Icon
                name="lucide:inbox"
                class="h-5 w-5 text-gray-400 mr-2 group-hover:text-[#c164ff]"
              />
